...
def parse_args() -> argparse.Namespace:
    ...
    g.add_argument('--nue-max', type=int, default=200, help='Maximum number of UEs (inclusive)')
...
def main() -> None:
    ...
    ax1 = fig1.gca()
    ax1.plot(sweeps_arr, se_base_vals, '-o', color='#4C78A8', label='3GPP', linewidth=1.8, markersize=4)
    ...
    ax2 = fig2.gca()
    ax2.plot(sweeps_arr, fj_base_vals, '-o', color='#4C78A8', label='3GPP', linewidth=1.8, markersize=4)
