"""
Toronto single-satellite config with 150m Radio Map resolution.
...
CONFIG = {
    ...
    # Use Toronto Radio Map - 150m resolution (finer granularity)
    "radio_map_mat_path": "radio_map/Toronto/RadioMap/RM_toronto150_dBm.mat",
    ...
    "report_basename": "toronto_single_150m",
}
