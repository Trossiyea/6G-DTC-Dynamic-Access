"""
Shanghai single-satellite config with 150m Radio Map resolution.

This configuration tests the finer 150m resolution Radio Map
to evaluate the impact of higher spatial granularity on scheduling performance.
"""
...
CONFIG = {
    ...
    # Use Shanghai Radio Map - 150m resolution (finer granularity)
    "radio_map_mat_path": "radio_map/Shanghai/RadioMap/RM_shanghai150_dBm.mat",
    ...
    "report_basename": "shanghai_single_150m",
}
