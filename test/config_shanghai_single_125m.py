"""
Shanghai single-satellite config with 125m Radio Map resolution.

This configuration tests the baseline 125m resolution Radio Map
to evaluate the impact of spatial granularity on scheduling performance.
"""
...
CONFIG = {
    ...
    # Use Shanghai Radio Map - 125m resolution
    ...
    "report_basename": "shanghai_single_125m",
}
